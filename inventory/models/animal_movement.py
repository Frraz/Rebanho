...
import uuid
from datetime import date  # ✅ ADICIONADO: necessário para default=date.today

from django.contrib.auth import get_user_model
from django.core.exceptions import ValidationError
from django.db import models

# ❌ REMOVIDO: from django.utils import timezone  (não é mais necessário)
...
class AnimalMovement(models.Model):
    ...
    # ✅ ALTERADO: DateTimeField → DateField
    timestamp = models.DateField(
        default=date.today,  # ✅ era: default=timezone.now
        verbose_name="Data da Operação",  # ✅ era: "Data/Hora da Operação"
        help_text="Data em que a operação foi realizada",  # ✅ era: "Momento em que..."
        db_index=True,
    )
    ...
    created_at = (
        models.DateTimeField(  # ✅ MANTIDO: auditoria técnica precisa de timestamp
            auto_now_add=True,
    ...
    class Meta:
        ...
        ordering = [
            "-timestamp",
            "-created_at",
        ]  # ✅ MANTIDO: funciona igual com DateField
        indexes = [
    ...
    def __str__(self):
        return (
            ...
            f"{self.quantity} ({self.timestamp.strftime('%d/%m/%Y')})"  # ✅ MANTIDO: funciona com date
        )
